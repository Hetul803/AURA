...
## Approval System
Aegisure requires explicit approval for risky agent actions, protected-path changes, and policy violations.

## Memory Engine
Aegisure keeps local and hosted workspace-scoped memory for provenance, attribution, project rules, and agent failure patterns.
