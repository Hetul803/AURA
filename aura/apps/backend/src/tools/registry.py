...
_TOOLS: dict[str, ToolSpec] = {
    ...
    'AGENT_DELEGATE': _spec('AGENT_DELEGATE', 'agent', 'Delegate to agent router', 'Ask Aegisure to route work to the best worker and prepare a self-contained agent prompt.', 'medium', permissions=['agent_route'], side_effects=['agent_task_created'], device_adapters=['desktop-local', 'enterprise-workspace']),
