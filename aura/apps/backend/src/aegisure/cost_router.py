...
def model_candidates() -> list[dict[str, Any]]:
    ...
    return [
        ...
        ModelCandidate('openai', 'gpt-5.5', 'OpenAI GPT-5.5 for Aegisure planning', 'cloud', 'premium', 0.01, 0.03, False, ('context', 'planning', 'writing', 'summarization', 'classification'), 'Configured later with user-controlled cloud policy.').to_dict(),
        ModelCandidate('anthropic', 'claude', 'Claude for Aegisure reasoning', 'cloud', 'premium', 0.008, 0.024, False, ('context', 'planning', 'writing', 'summarization', 'classification'), 'Configured later with user-controlled cloud policy.').to_dict(),
