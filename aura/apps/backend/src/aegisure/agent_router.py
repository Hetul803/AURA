...
def _codex_available() -> bool:
    return bool(os.environ.get('AEGISURE_CODEX_ENABLED') == '1' or os.environ.get('CODEX_HOME'))
...
def build_agent_prompt(
    *,
    ...
    return '\n'.join([
        'You are a coding worker inside Aegisure, the user-owned AI operating layer.',
        'Follow Aegisure policy: inspect first, make scoped edits only, protect secrets, do not delete, do not push without approval.',
        f'Task: {task}',
