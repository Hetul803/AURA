    ...
    *,
    ...
    result = remember_item(
        ...
        provenance={
            'source': source,
            'created_at': now,
            'explanation': 'Aegisure learned this as a candidate memory and is waiting for you to keep, edit, or forget it.',
            **(provenance or {}),
        },
        ...
        metadata={
            ...
            'why_it_matters': 'This may help Aegisure personalize future work.',
            **(metadata or {}),
        },
    )
