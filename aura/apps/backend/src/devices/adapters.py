...
_ADAPTERS: dict[str, DeviceAdapterSpec] = {
    'desktop-local': DeviceAdapterSpec(
        ...
        surface='desktop',
        status='available',
        description='Primary Aegisure surface for local OS context, shell, filesystem, clipboard, and overlay approvals.',
    ...
    'enterprise-workspace': DeviceAdapterSpec(
        ...
        surface='enterprise',
        status='planned',
        description='Future company Aegisure adapter for RBAC, admin policy, company memory, and team workflow agents.',
